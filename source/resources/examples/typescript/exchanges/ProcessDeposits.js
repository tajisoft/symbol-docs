...
const example = async () => {
  ...
  const config = {
    ...
    // Replace with http://<API-NODE-URL>:3000/network/properties generationHashSeed
    ...
    const transactionIndex =
      (_a =
        transactionInfo === null || transactionInfo === void 0
          ? void 0
          : transactionInfo.index) !== null && _a !== void 0
        ? _a
        : 0;
    const transactionHash =
      transactionInfo instanceof symbol_sdk_1.AggregateTransactionInfo
        ...
        : (_b =
            transactionInfo === null || transactionInfo === void 0
              ? void 0
              : transactionInfo.hash) !== null && _b !== void 0
        ? _b
        : '';
    return (
      // 2.a
    ...
    const transactionHash =
      transactionInfo instanceof symbol_sdk_1.AggregateTransactionInfo
        ...
        : (_a =
            transactionInfo === null || transactionInfo === void 0
              ? void 0
              : transactionInfo.hash) !== null && _a !== void 0
        ? _a
        : '';
    const transactionIndex =
      (_b =
        transactionInfo === null || transactionInfo === void 0
          ? void 0
          : transactionInfo.index) !== null && _b !== void 0
        ? _b
        : 0;
    const amount =
